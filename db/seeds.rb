...
hive_shiyun_1 = Hive.create!(category: Hive::CATEGORIES.sample, queen: shiyun, name: "La ruche sous les étoiles",
...
hive_shiyun_2 = Hive.create!(category: Hive::CATEGORIES.sample, queen: shiyun, name: "La ruche au moulin", description: "Évadez-vous le temps d'un instant,
...
hive_aurore_2 = Hive.create!(category: Hive::CATEGORIES.sample, queen: aurore, name: "La ruche enchantée", description: "Cette ruche n'est pas féerique,non
...
hive_aurore_3 = Hive.create!(category: Hive::CATEGORIES.sample, queen: aurore, name: "La ruche sportive", description: "Le calme reigne près de
...
hive_miel_pops_1 = Hive.create!(category: Hive::CATEGORIES.sample, queen: miel_pops, name: "La ruche de votre petit déjeuner", description: "Le soleil nous réveille, il fait beau, il fait chaud, c'est le moment pour
...
hive_jj_1 = Hive.create!(category: Hive::CATEGORIES.sample, queen: jj, name: "La ruche posey", description: "Venez vous détendre dans une ruche au milieu des champs de chanvres,
...
hive_hugo_1 = Hive.create!(category: Hive::CATEGORIES.sample, queen: hugo, name: "La ruche nouvelle génération", description: "Venez produire votre petite dose de miel, sans risquer de vous faire enfumer",
...
hive_aurore_4 = Hive.create!(category: Hive::CATEGORIES.sample, queen: aurore, name: "La ruche familiale", description: "Une belle ruche prête à accueillir toute votre petite famille !
                            Admirez un cadre exceptionnel pour toute la famille. Bzzz bzzz...",
                            address: "21 rue du Sergent Thierry 44230 Saint-Sébastien-sur-Loire", price_per_day: 10)
